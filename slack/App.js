...
import { ActivityIndicator, View, StyleSheet, SafeAreaView, LogBox } from 'react-native';
...
import { ChatUserContext, ChatClientService, USER_TOKENS, USERS } from './src/utils';
...
const ModalStackNavigator = (props) => {
	return (
		<ModalStack.Navigator initialRouteName='Home' mode='modal'>
			<ModalStack.Screen name='Tabs' component={TabNavigation} options={{ headerShown: false }} />
			<ModalStack.Screen
...
const HomeStackNavigator = (props) => {
	return (
		<HomeStack.Navigator initialRouteName='ModalStack'>
			<HomeStack.Screen name='ModalStack' component={ModalStackNavigator} options={{ headerShown: false }} />
			<HomeStack.Screen
				name='ChannelScreen'
